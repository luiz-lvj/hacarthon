...
"[project]/node_modules/twilio/lib/rest/numbers/v1/embeddedSession.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class NumbersV1PortingLosingCarrierInformation {
    constructor(payload){
        ...
        this.authorizedRepresentativeEmail = payload["authorized_representative_email"];
        this.customerType = payload["customer_type"];
        this.authorizedRepresentativeKatakana = payload["authorized_representative_katakana"];
...
class NumbersV1PortingPortInPhoneNumberResult {
    constructor(payload){
        ...
        this.statusLastTimeUpdatedTimestamp = payload["status_last_time_updated_timestamp"];
        this.externalPortingVendorPhoneNumberId = payload["external_porting_vendor_phone_number_id"];
    }
}
...
class PortingPortInInstance {
    constructor(_version, payload, portInRequestSid){
        ...
        this.losingCarrierInformation = payload.losing_carrier_information !== null && payload.losing_carrier_information !== undefined ? new NumbersV1PortingLosingCarrierInformation(payload.losing_carrier_information) : null;
        this.phoneNumbers = payload.phone_numbers !== null && payload.phone_numbers !== undefined ? payload.phone_numbers.map((payload)=>new NumbersV1PortingPortInPhoneNumberResult(payload)) : null;
        this.bundleSid = payload.bundle_sid;
        this.portabilityAdvanceCarrier = payload.portability_advance_carrier;
        this.autoCancelApprovalNumbers = payload.auto_cancel_approval_numbers;
        this.documents = payload.documents;
...
"[project]/node_modules/twilio/lib/rest/numbers/v1/senderIdRegistration.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const embeddedSession_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/numbers/v1/embeddedSession.js [app-route] (ecmascript)");
...
const senderIdRegistration_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/numbers/v1/senderIdRegistration.js [app-route] (ecmascript)");
...
class V1 extends Version_1.default {
    ...
    /** Accessor for embeddedSessions resource */ embeddedSessions(BundleSid) {
    ...
    /** Getter for senderIdRegistrations resource */ get senderIdRegistrations() {
        this._senderIdRegistrations = this._senderIdRegistrations || (0, senderIdRegistration_1.SenderIdRegistrationListInstance)(this);
...
function BundleListInstance(version) {
    ...
    instance.page = function page(params, callback) {
        ...
        let data = {};
        if (params["status"] !== undefined) data["Status"] = params["status"];
        if (params["bundleSids"] !== undefined) data["BundleSids"] = params["bundleSids"];
        if (params["friendlyName"] !== undefined) data["FriendlyName"] = params["friendlyName"];
        if (params["regulationSid"] !== undefined) data["RegulationSid"] = params["regulationSid"];
        if (params["isoCountry"] !== undefined) data["IsoCountry"] = params["isoCountry"];
        if (params["numberType"] !== undefined) data["NumberType"] = params["numberType"];
...
//# sourceMappingURL=node_modules_twilio_lib_rest_numbers_0nmkvdb._.js.map