...
class UsAppToPersonContextImpl {
    ...
    fetch(params, callback) {
        ...
        const headers = {};
        headers["Accept"] = "application/json";
        if (params["xTwilioApiVersion"] !== undefined) headers["X-Twilio-Api-Version"] = params["xTwilioApiVersion"];
        const instance = this;
        let operationVersion = instance._version, operationPromise = operationVersion.fetch({
            uri: instance._uri,
            method: "get",
...
class ChannelsSenderInstance {
    constructor(_version, payload, sid){
        ...
        this.offlineReasons = payload.offline_reasons !== null && payload.offline_reasons !== undefined ? payload.offline_reasons.map((payload)=>new MessagingV2ChannelsSenderOfflineReasonsItems(payload)) : null;
...
"[project]/node_modules/twilio/lib/rest/messaging/v3/typingIndicator.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/twilio/lib/rest/messaging/V3.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const Version_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/twilio/lib/base/Version.js [app-route] (ecmascript)"));
const typingIndicator_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/messaging/v3/typingIndicator.js [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_twilio_lib_rest_messaging_0i7rbn7._.js.map