...
"[project]/node_modules/twilio/lib/rest/conversations/v2/action.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/twilio/lib/rest/conversations/v2/communication.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const util_1 = __turbopack_context__.r("[externals]/util [external] (util, cjs)");
const TokenPage_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/twilio/lib/base/TokenPage.js [app-route] (ecmascript)"));
const deserialize = __turbopack_context__.r("[project]/node_modules/twilio/lib/base/deserialize.js [app-route] (ecmascript)");
const serialize = __turbopack_context__.r("[project]/node_modules/twilio/lib/base/serialize.js [app-route] (ecmascript)");
const utility_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/base/utility.js [app-route] (ecmascript)");
...
class CommunicationInstance {
    constructor(_version, _payload, conversationSid, sid){
        ...
        this.author = payload.author !== null && payload.author !== undefined ? new ConversationsV2ParticipantAddress(payload.author) : null;
        this.content = payload.content !== null && payload.content !== undefined ? new ListCommunicationByConversation200ResponseCommunicationsContent(payload.content) : null;
        this.channelId = payload.channelId;
        this.resourceId = payload.resourceId;
        this.recipients = payload.recipients !== null && payload.recipients !== undefined ? payload.recipients.map((payload)=>new ListCommunicationByConversation200ResponseCommunicationsRecipients(payload)) : null;
        this.createdAt = deserialize.iso8601DateTime(payload.createdAt);
        this.updatedAt = deserialize.iso8601DateTime(payload.updatedAt);
    ...
    get _proxy() {
        this._context = this._context || new CommunicationContextImpl(this._version, this._solution.conversationSid, this._solution.sid);
        return this._context;
    }
    /**
...
function CommunicationListInstance(version, conversationSid) {
    ...
    instance.page = function page(params, callback) {
        ...
        let data = {};
        if (params["channelId"] !== undefined) data["channelId"] = params["channelId"];
        if (params["pageSize"] !== undefined) data["pageSize"] = params["pageSize"];
        if (params["pageToken"] !== undefined) data["pageToken"] = params["pageToken"];
        const headers = {};
        headers["Accept"] = "application/json";
...
"[project]/node_modules/twilio/lib/rest/conversations/v2/configuration.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class ConfigurationInstance {
    constructor(_version, _payload, sid){
        ...
        this.memoryStoreId = payload.memoryStoreId;
        this.channelSettings = payload.channelSettings;
        this.statusCallbacks = payload.statusCallbacks !== null && payload.statusCallbacks !== undefined ? payload.statusCallbacks.map((payload)=>new ConversationsV2StatusCallbackConfig(payload)) : null;
        this.intelligenceConfigurationIds = payload.intelligenceConfigurationIds;
        this.memoryExtractionEnabled = payload.memoryExtractionEnabled;
    ...
    get _proxy() {
        this._context = this._context || new ConfigurationContextImpl(this._version, this._solution.sid);
        return this._context;
    }
    remove(params, callback) {
        return this._proxy.remove(params, callback);
...
function ConfigurationListInstance(version) {
    ...
    instance.page = function page(params, callback) {
        ...
        if (params["pageSize"] !== undefined) data["pageSize"] = params["pageSize"];
        if (params["pageToken"] !== undefined) data["pageToken"] = params["pageToken"];
        if (params["memoryStoreId"] !== undefined) data["memoryStoreId"] = params["memoryStoreId"];
        const headers = {};
        headers["Accept"] = "application/json";
        let operationVersion = version, operationPromise = operationVersion.page({
            uri: instance._uri,
...
"[project]/node_modules/twilio/lib/rest/conversations/v2/conversation.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class ConversationInstance {
    constructor(_version, _payload, sid){
        ...
        this.participants = payload.participants !== null && payload.participants !== undefined ? payload.participants.map((payload)=>new ConversationsV2Participant(payload)) : null;
        this._solution = {
            sid: sid
        };
    }
...
function ConversationListInstance(version) {
    ...
    instance.page = function page(params, callback) {
        ...
        let data = {};
        if (params["status"] !== undefined) data["status"] = serialize.map(params["status"], (e)=>e);
        if (params["channelId"] !== undefined) data["channelId"] = params["channelId"];
        if (params["pageSize"] !== undefined) data["pageSize"] = params["pageSize"];
        if (params["pageToken"] !== undefined) data["pageToken"] = params["pageToken"];
        const headers = {};
...
"[project]/node_modules/twilio/lib/rest/conversations/v2/operation.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class OperationInstance {
    ...
    get _proxy() {
        this._context = this._context || new OperationContextImpl(this._version, this._solution.sid);
        return this._context;
    }
    /**
...
"[project]/node_modules/twilio/lib/rest/conversations/v2/participant.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class ParticipantInstance {
    constructor(_version, _payload, conversationSid, sid){
        ...
        this.type = payload.type;
        this.profileId = payload.profileId;
        this.addresses = payload.addresses !== null && payload.addresses !== undefined ? payload.addresses.map((payload)=>new ConversationsV2Address(payload)) : null;
        this.createdAt = deserialize.iso8601DateTime(payload.createdAt);
        this.updatedAt = deserialize.iso8601DateTime(payload.updatedAt);
        this._solution = {
            conversationSid,
...
"[project]/node_modules/twilio/lib/rest/conversations/V2.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const Version_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/twilio/lib/base/Version.js [app-route] (ecmascript)"));
const action_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/conversations/v2/action.js [app-route] (ecmascript)");
const communication_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/conversations/v2/communication.js [app-route] (ecmascript)");
const configuration_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/conversations/v2/configuration.js [app-route] (ecmascript)");
const conversation_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/conversations/v2/conversation.js [app-route] (ecmascript)");
const operation_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/conversations/v2/operation.js [app-route] (ecmascript)");
const participant_1 = __turbopack_context__.r("[project]/node_modules/twilio/lib/rest/conversations/v2/participant.js [app-route] (ecmascript)");
class V2 extends Version_1.default {
    ...
    /** Accessor for actions resource */ actions(ConversationId) {
        return (0, action_1.ActionListInstance)(this, ConversationId);
    }
    /** Implementation */ communications(ConversationSid, sid) {
    ...
    /** Getter for configurations resource */ get configurations() {
        this._configurations = this._configurations || (0, configuration_1.ConfigurationListInstance)(this);
    ...
    /** Getter for operations resource */ get operations() {
        this._operations = this._operations || (0, operation_1.OperationListInstance)(this);
        return this._operations;
    }
    /** Implementation */ participants(ConversationSid, sid) {
...
//# sourceMappingURL=node_modules_twilio_lib_rest_conversations_0jnyrok._.js.map