...
class AssistantsV1ServiceCustomerAi {
    constructor(payload){
        ...
        this.personalizationEngineEnabled = payload["personalization_engine_enabled"];
    }
}
...
class AssistantInstance {
    constructor(_version, payload, id){
        ...
        this.dateCreated = deserialize.iso8601DateTime(payload.date_created);
        this.dateUpdated = deserialize.iso8601DateTime(payload.date_updated);
        this.knowledge = payload.knowledge !== null && payload.knowledge !== undefined ? payload.knowledge.map((payload)=>new AssistantsV1ServiceKnowledge(payload)) : null;
        this.tools = payload.tools !== null && payload.tools !== undefined ? payload.tools.map((payload)=>new AssistantsV1ServiceTool(payload)) : null;
        this._solution = {
            id: id || this.id
        };
    }
...
class ToolInstance {
    constructor(_version, payload, id){
        ...
        this.dateCreated = deserialize.iso8601DateTime(payload.date_created);
        this.dateUpdated = deserialize.iso8601DateTime(payload.date_updated);
        this.policies = payload.policies !== null && payload.policies !== undefined ? payload.policies.map((payload)=>new AssistantsV1ServicePolicy(payload)) : null;
        this._solution = {
            id: id || this.id
        };
    }
...
//# sourceMappingURL=node_modules_twilio_lib_rest_assistants_04-xjo7._.js.map