...
class SubscribeRulesInstance {
    constructor(_version, payload, roomSid, participantSid){
        ...
        this.participantSid = payload.participant_sid;
        this.roomSid = payload.room_sid;
        this.rules = payload.rules !== null && payload.rules !== undefined ? payload.rules.map((payload)=>new VideoV1RoomRoomParticipantRoomParticipantSubscribeRuleRules(payload)) : null;
        this.dateCreated = deserialize.iso8601DateTime(payload.date_created);
        this.dateUpdated = deserialize.iso8601DateTime(payload.date_updated);
    }
    /**
...
class RecordingRulesInstance {
    constructor(_version, payload, roomSid){
        this._version = _version;
        this.roomSid = payload.room_sid;
        this.rules = payload.rules !== null && payload.rules !== undefined ? payload.rules.map((payload)=>new VideoV1RoomRoomRecordingRuleRules(payload)) : null;
        this.dateCreated = deserialize.iso8601DateTime(payload.date_created);
        this.dateUpdated = deserialize.iso8601DateTime(payload.date_updated);
    }
    /**
...
//# sourceMappingURL=node_modules_twilio_lib_rest_video_1ysw_8y._.js.map